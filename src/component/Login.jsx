...
const Login = () => {
    ...
    return (
        <div className="bg-slate-800 h-screen">
            <div >
                <form onSubmit={handleSubmit} className=" w-full md:w-4/12 absolute p-10 bg-black my-16 mx-auto right-0 left-0 text-white bg-opacity-50">
                    ...
                    <input type="password" placeholder="Enter Password" className="p-4 my-2 w-full bg-gray-700" value={password} onChange={(e)=>setPassword(e.target.value)}/>
